...
Iris *houghMethod(ImgBin *img, Img *testImage, char *filename)
{
		...
		drawIris(testImage, outFilepath("test/", filename, "_iris", "pbm"), iris);
		segIris(testImage, outFilepath("test/", filename, "_seg_iris", "pbm"), iris);
